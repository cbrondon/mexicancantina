...
public class LatteActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                coffeePrice.setText("MXN $ " + ifCheckBox);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    Toast.makeText(LatteActivity.this, "No puedes pedir menos", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int coffePrice = basePrice * quantity;
    ...
    private boolean SaveCart() {
        ...
        if (addExtraCream.isChecked()) {
            values.put(OrderContract.OrderEntry.COLUMN_CREAM, "Crema: SI");
        } else {
            values.put(OrderContract.OrderEntry.COLUMN_CREAM, "Crema: NO");

        }

        if (addToppings.isChecked()) {
            values.put(OrderContract.OrderEntry.COLUMN_HASTOPPING, "Azúcar: SI");
        } else {
            values.put(OrderContract.OrderEntry.COLUMN_HASTOPPING, "Azúcar: NO");
        ...
        if (mCurrentCartUri == null) {
            ...
            if (newUri==null) {
                Toast.makeText(this, "Hubo un problema al agregar el producto", Toast.LENGTH_SHORT).show();
            } else {
